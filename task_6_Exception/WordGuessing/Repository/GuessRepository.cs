...
namespace WordGuessing.Repository
{
    class GuessRepository : IRepository<string, Guess>
    {
        ...
        //method for getting all the list data 
        public List<Guess>? GetAllData()
        {
            if (_guessMap.Count > 0) //check if the list reaches the maximum attempt
            {
                return _guessMap;
            }
            return null;
